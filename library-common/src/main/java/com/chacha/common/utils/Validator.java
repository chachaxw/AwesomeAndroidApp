...
public class Validator {
    ...
    public static boolean isPrice(String str) {
        Pattern pattern = Pattern
                .compile("^(([1-9]\\d*)|([0]))(\\.(\\d){0,2})?$"); // 判断小数点后2位的数字的正则表达式
    ...
    /**
     * isCodeEqual(验证验证码是否与服务器发送来的一致)<br/>
     *
     ...
     * @since 1.0.0
     */
    public static boolean isCodeEqual(String codeStr, String netCode) {
        return TextUtils.equals(codeStr, netCode);
    }
